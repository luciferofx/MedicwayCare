...
const BookingManagement = () => {
    ...
    const fetchBookings = async (pageNum = 1, searchQuery = '', type = '', status = '') => {
        ...
        try {
            ...
            let url = `${url_prefix}/bookings?page=${pageNum}&limit=${limit}`; // ✅ FIXED: Removed /admin/
...
Medical Team
    ...
    const updateBookingStatus = async (bookingId, updates) => {
        ...
        try {
            ...
            const response = await fetch(`${url_prefix}/bookings/${bookingId}`, { // ✅ FIXED: Removed /admin/
                method: 'PUT',
                headers: {
    ...
    const handleDeleteBooking = async (id) => {
        ...
        try {
            const response = await fetch(`${url_prefix}/bookings/${id}`, { // ✅ FIXED: Removed /admin/
                method: 'DELETE',
                headers: { Authorization: `Bearer ${token}` },
            });
            const result = await response.json();
